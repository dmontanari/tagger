...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&authorName, "author", "a", "Tagger", "Author for ccmmit")
	rootCmd.PersistentFlags().StringVarP(&authorEmail, "email", "e", "tagger@bot", "Email for commit")
	rootCmd.PersistentFlags().StringVarP(&commitMessage, "message", "", "Version generated by tagger", "Commit message")
